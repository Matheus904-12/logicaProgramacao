...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($cnt > 0) {
        ...
        echo "<div class='erro'>O email <strong>" . htmlspecialchars($email) . "</strong> já está cadastrado.</div>";
        $conn->close();
        exit;
    }
